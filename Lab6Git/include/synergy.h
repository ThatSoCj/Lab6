...
/* client → server */
typedef struct {
    sng_int32 length;  // length of command
} tsh_shell_it;
...
typedef struct {
    sng_int16 status;
    sng_int16 error;
    sng_int32 stdoutLength;      // add this
    char      stdout[1024];
} tsh_shell_ot;